package dragon.bakuman.iu.spotifyscratchaudiostreammitch.adapters;
...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeRecyclerAdapter(ArrayList<String> categories, Context context, IHomeSelector IHomeSelector) {
